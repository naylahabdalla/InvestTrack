...
def currency():
    ...
    if request.method == "POST":
        ...
        selected_from = from_curr
        selected_to = to_curr
        entered_amount = amount if amount > 0 else None
    ...
    quizzes = {
        ...
        "realestate": {
            ...
            "questions": [
                ...
                {"q": "Leverage in real estate is:", "opts": {"a": "Using a hammer", "b": "Using borrowed capital", "c": "Buying with cash only"}, "ans": "b"},
