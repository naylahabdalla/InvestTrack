  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-end absolute -right-60 -top-10 blur-xl z-0 ">
        <div className="h-[10rem] rounded-full w-[60rem] z-1 bg-gradient-to-b blur-[6rem] from-green-600 to-teal-600"></div>
      ...
      <div className="relative z-10">
        ...
        <nav className="container mx-auto flex items-center justify-between px-4 py-4 mt-6">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-white">InvestTrack</span>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-6">
            <div className="flex items-center space-x-6">
              <NavItem label="Analytics" hasDropdown />
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="mt-8 flex flex-col space-y-6">
                <MobileNavItem label="Analytics" />
                <MobileNavItem label="Portfolio" />
        ...
        <div className="mx-auto mt-6 flex max-w-fit items-center justify-center space-x-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
          <span className="text-sm font-medium text-white">
            Join the revolution today! Maximize your returns.
          </span>
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300">
            Real-time analytics, powerful portfolio tracking, and intelligent insights. 
            InvestTrack simplifies your wealth journey. Join thousands of investors today!
          </p>
          ...
          <div className="relative mx-auto my-20 w-full max-w-6xl">
            <div className="absolute inset-0 rounded shadow-lg bg-green-500/20 blur-[10rem] opacity-40" />

            {/* Hero Image */}
            <img
              src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&q=80&w=1920"
              alt="Investment Tracker Dashboard Demo"
              className="relative w-full h-auto shadow-2xl rounded-xl border border-gray-800"
            />
          </div>
        </div>
      </div>
...
function MobileNavItem({ label }: { label: string }) {
  return (
    <div className="flex items-center justify-between border-b border-gray-800 pb-2 text-lg text-white cursor-pointer hover:text-green-400 transition-colors">
      <span>{label}</span>
